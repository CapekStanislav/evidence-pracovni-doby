 ...
 */
package cz.stanislavcapek.evidencepd.service.template;
...
public class XlsxTemplateFactory {
    ...
    public static final String TITLE = "Měsíční rozpis služeb - Městská policie Třebechovice pod Orebem";
    ...
    public static XSSFWorkbook create(List<Employee> employeeList, int year) {
        ...
        for (int i = 0; i < months.length; i++) {
            ...
            for (int j = 0; j < employeeList.size(); j++) {
                ...
                cell.setCellStyle(format.getCenterBorderNoColorStyle());
                cell.setCellValue(WorkingTimeFund.calculateWorkingTimeFund(date));
